            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 gap-10 xl:gap-4 font-roboto lg:w-2/3 xl:w-1/2">
                <div className="">
                    ...
                    <div className="mt-4 xl:mt-8 space-y-6">
                        <a href="https://ask4bg.org" className="block w-max text-white" target="_blank">Home</a>
                        <a href="https://ask4bg.org/about-us" className="block w-max text-white" target="_blank">About Us</a>
                    </div>
                </div>
                ...
                <div className="">
                    ...
                    <div className="mt-4 xl:mt-8 space-y-2 lg:space-y-6">
                        <a href="https://ask4bg.org#faqs" className="block w-max text-white" target="_blank">FAQs</a>
                        <a href="https://ask4bg.org/terms-of-use" className="block w-max text-white" target="_blank">Terms & Conditions</a>
                        <a href="https://ask4bg.org/privacy-policy" className="block w-max text-white" target="_blank">Privacy</a>
                    </div>
                </div>
                <div className="">
                    ...
                    <div className="mt-4 xl:mt-8 space-y-2 lg:space-y-6">
                        ...
                        <a href="#" target="_blank" className="block w-max text-white">LinkedIn</a>
                    </div>
                </div>
                <div className="">
                    ...
                    <div className="mt-4 xl:mt-8 space-y-2 lg:space-y-6">
                        ...
                        <a href="https://ui.edu.ng" target="_blank" className="block w-max text-white">UIRF</a>
                    </div>
                </div>
            </div>
        </div>
